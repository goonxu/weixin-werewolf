...
var log = debug('webot-werewolf:log');
var verbose = debug('webot-werewolf:verbose');
var error = debug('webot-werewolf:error');
...
module.exports = exports = function(webot){
  ...
  webot.set({
    ...
    handler: function(info){
      var reply = {
        title: '感谢你收听webot机器人',
        pic: 'https://raw.github.com/node-webot/webot-werewolf/master/qrcode.jpg',
        url: 'https://github.com/node-webot/webot-werewolf',
        description: [
          '你可以试试以下指令:',
            'game : 玩玩猜数字的游戏吧',
            's+空格+关键词 : 我会帮你百度搜索喔',
  ...
  webot.set('reply_news', {
    ...
    handler: function(info){
      var reply = [
        {title: '微信机器人', description: '微信机器人测试帐号：webot', pic: 'https://raw.github.com/node-webot/webot-werewolf/master/qrcode.jpg', url: 'https://github.com/node-webot/webot-werewolf'},
        ...
        {title: '图文消息3', description: '图文消息描述3', pic: 'https://raw.github.com/node-webot/webot-werewolf/master/qrcode.jpg', url: 'http://www.baidu.com'}
      ];
