...
var log = require('debug')('webot-werewolf:log');
var verbose = require('debug')('webot-werewolf:verbose');
...
if(!process.env.DEBUG){
  console.log("set env variable `DEBUG=webot-werewolf:*` to display debug info.");
}
